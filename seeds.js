...
licences.forEach((licence) => {
	try {
		let result = licenceKey.createLicense({ info: licence.client, prodCode: 'L2048' });
...
Licence.deleteMany()
	...
	.then((licecesCreated) => {
		console.log(`${licecesCreated.length} licences were added to the database with the following id: `);
